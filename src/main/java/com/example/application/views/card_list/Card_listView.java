package com.example.application.views.card_list;
...
public class Card_listView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public Card_listView() {
        addClassName("cardlist-view");
        setSizeFull();
        grid.setHeight("100%");
