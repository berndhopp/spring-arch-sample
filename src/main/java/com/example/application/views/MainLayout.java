...
import com.example.application.views.card_list.Card_listView;
 ...
 */
@PWA(name = "spring_arch_sample", shortName = "spring_arch_sample", enableInstallPrompt = false)
@Theme(themeFolder = "springarchsample")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("spring_arch_sample");
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("card_list", "la la-list", Card_listView.class), //
